...
function fillMap(year) {
    ...
    $.getJSON("https://www.ischlosser.com/Assessment/ColorGeo/"+year, function (data, status) {
...
function allcolorsforcountry(country) {
    ...
    $.getJSON("https://www.ischlosser.com/Assessment/Color/"  + country + "/All/"+year, function (data) {
...
function countryandcolor(country, color) {
    ...
    $.getJSON("https://www.ischlosser.com/Assessment/Color/" + country + "/" + color + "/"+year, function (data) {
...
function getcolors() {
    ...
    $.getJSON("https://www.ischlosser.com/Assessment/Color/All/All/"+year, function (data) {
